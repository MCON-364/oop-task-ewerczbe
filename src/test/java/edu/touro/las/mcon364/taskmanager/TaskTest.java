...
class TaskTest {
    ...
    void testTaskCreation() {
        ...
        assertEquals("Test task", task.name(), "Task name should match");  // For a record, use name() method
        assertEquals(Priority.HIGH, task.priority(), "Task priority should match");  // For a record, use priority() method
    }
